...
MessageFactory.prototype.createGetMapsMessage = function (values) {
	var names = ["type"];
	var msg = new Message(names,values,"GetMapsMessage");
	return msg.toJSONString();
}

MessageFactory.prototype.createMessageFromData = function(data){
	//TODO create messages from json string;
}
